...
const AuthModal = ({ isOpen, onClose, mode, userType, setMode, setUserType }: AuthModalProps) => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    console.log('Form submitted:', { ...formData, userType, mode });
    
    toast({
      title: mode === 'login' ? "Login Successful" : "Registration Successful",
      description: `You have successfully ${mode === 'login' ? 'logged in' : 'registered'} as a ${userType}.`,
    });
              ...
              {mode === 'register' && (
                <>
                  ...
                  <div className="bg-dal-gray-light p-3 rounded-md text-sm">
                    ...
                    <p>Registration requires verification with your Bar Council ID. Additional verification steps will follow after initial registration.</p>
                  </div>
                </>
              )}
              <div className="space-y-2">
